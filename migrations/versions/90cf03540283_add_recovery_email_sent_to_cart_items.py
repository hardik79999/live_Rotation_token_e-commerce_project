"""add recovery_email_sent to cart_items

Revision ID: 90cf03540283
Revises: e49538d2e2e2
Create Date: 2026-04-19 02:11:29.789003
...
revision = '90cf03540283'
down_revision = 'e49538d2e2e2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('cart_items', schema=None) as batch_op:
        batch_op.add_column(sa.Column('recovery_email_sent', sa.Boolean(), nullable=False))
...
def downgrade():
    ...
    with op.batch_alter_table('cart_items', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_column('recovery_email_sent')
